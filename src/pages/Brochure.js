...
const Brochure = () => {
    ...
    const fetchBrochures = async () => {
        try {
            const response = await axios.get("https://api.magnumwonderplast.com/admin_api/brochure.php");
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editMode) {
                ...
                await axios.post("https://api.magnumwonderplast.com/admin_api/brochure.php?_method=PUT", form);
                Swal.fire("Success!", "Brochure updated successfully.", "success");
            } else {
                await axios.post("https://api.magnumwonderplast.com/admin_api/brochure.php", form);
    ...
    const handleDelete = async (id) => {
        ...
        if (confirm.isConfirmed) {
            try {
                await axios.delete("https://api.magnumwonderplast.com/admin_api/brochure.php", {
                    data: { id },
                });
